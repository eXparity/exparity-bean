...
public class GraphTest {
	...
	public void canGetAPropertyValueByPredicate() {
		Person instance = new Person();
		instance.setFirstname("Tina");
		assertThat(graph(instance).propertyValue(withName("firstname")), equalTo((Object) "Tina"));
	}

	@Test
	public void canGetAPropertyValueByPredicateNoMatch() {
		assertThat(graph(new Person()).propertyValue(withName("missing")), nullValue());
	}
	...
	public void canGetAPropertyTypedValueByName() {
		Person instance = new Person();
		instance.setFirstname("Tina");
		assertThat(graph(instance).propertyValue(withName("firstname"), String.class), equalTo("Tina"));
	}

	@Test
	public void canGetAPropertyTypedValueByPredicateNoMatch() {
		assertThat(graph(new Person()).propertyValue(withName("missing"), String.class), nullValue());
	}
	...
	public void canSetAPropertyByPredicate() {
		assertThat(graph(new Person()).setProperty(withName("firstname"), "Bob"), equalTo(true));
	}

	@Test
	public void canSetAPropertyByPredicateNoMatch() {
		assertThat(graph(new Person()).setProperty(withName("missing"), "Bob"), equalTo(false));
	}
	...
	public void canGetAPropertyByPredicate() {
		assertThat(graph(new Person()).get(withName("firstname")), notNullValue());
	}

	@Test
	public void canGetAPropertyByPredicateNoMatch() {
		assertThat(graph(new Person()).get(withName("missing")), nullValue());
	}
	...
	public void canGetAPropertyTypeByPredicate() {
		assertThat(graph(new Person()).propertyType(withName("firstname")), equalTo((Class) String.class));
	}

	@Test
	public void canGetAPropertyTypeByPredicateNoMatch() {
		assertThat(graph(new Person()).propertyType(withName("missing")), nullValue());
	}
	...
	public void canCheckIfPropertyExistsByPredicate() {
		assertThat(graph(new Person()).hasProperty(withName("firstname")), equalTo(true));
	}

	@Test
	public void canCheckIfPropertyExistsByPredicateNoMatch() {
		assertThat(graph(new Person()).hasProperty(withName("missing")), equalTo(false));
	}
	...
	public void canCheckPropertyTypeByPredicate() {
		assertThat(graph(new Person()).isPropertyType(withName("firstname"), String.class), equalTo(true));
	}

	@Test
	public void canCheckPropertyTypeByPredicateNoMatch() {
		assertThat(graph(new Person()).isPropertyType(withName("missing"), String.class), equalTo(false));
	}
	...
	public void canFindAPropertyOnABean() {
		Person instance = new Person();
		assertThat(graph(instance).find(withName("firstname")), hasItem(equalTo(bean(instance).propertyNamed("firstname"))));
	}

	@Test
	public void canNotFindAPropertyOnABean() {
		assertThat(graph(new Person()).find(withName("missing")), hasSize(0));
	}
	...
	public void canApplyAFunctionToABeanWithPredicate() {
		...
		assertThat(instance.getFirstname(), not(equalTo("Applied")));
		assertThat(instance.getSurname(), not(equalTo("Applied")));
		graph(instance).apply(setValue("Applied"), withType(String.class));
		assertThat(instance.getFirstname(), equalTo("Applied"));
		assertThat(instance.getSurname(), equalTo("Applied"));
	}
}
